...
A_bar=(1/A0)*((q1*P_t)+(q2*P_t_2));

m_A(round(100*q2),round(100*q1))=minimizer(A_bar);


if m_A(round(100*q2),round(100*q1)) > 0.99
shart=0;
AF_Bound(round(100*q2))=q1
end
q1=q1+0.01
end

if shart==1
    AF_Bound(round(100*q2))=1;
end
