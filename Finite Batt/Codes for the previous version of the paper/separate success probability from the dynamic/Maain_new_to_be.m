...
N_i=1000000;   % the number of fading simulated 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Noise_dbm=-100;
...
[T_d1_num,T_d1_sim]=T_d1 (Noise,gamma,g1,sigma_1,N_i);
[T_d12_num,T_d12_sim]=T_d12(rho,Noise,gamma,g1,g2,sigma_1,sigma_2,N_i);
[T_e2_num,T_e2_sim]=T_e2(gamma_e,g2,sigma_2,N_i);
[T_e12_num,T_e12_sim]=T_e12(rho,gamma_e,g1,g2,sigma_1,sigma_2,N_i);
...
AF_Num(round(rt*20))=1/A0;
AoI_Num(round(rt*20))=1/I0;
